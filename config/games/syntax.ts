    ...
    .setCodeBlock(
        new CodeBlock(
            [
                ...
                new CodeLine("  b: int = 12.34", StateEnum.ERROR, "Incorrect type hint, assigning a float to an int."),
                new CodeLine("  b: int = '12.34'", StateEnum.ERROR, "Type mismatch, casting a string to int, then incorrectly assigning to float."),
